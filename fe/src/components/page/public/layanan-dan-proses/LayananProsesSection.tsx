...
const LayananProsesSection: React.FC = () => {
  return (
    <div className="w-full bg-background text-foreground overflow-hidden pt-20">
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto space-y-16 border-b border-border/80">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="p-10 border border-border/80 bg-card space-y-6 hover:border-foreground/60 transition-colors flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                <span className="font-serif text-2xl font-normal text-foreground">01. Jas Formal &amp; Bespoke Tuxedo</span>
                <Icon icon="mdi:tie" className="text-3xl text-muted-foreground" />
              </div>
              <p className="font-serif text-base text-muted-foreground leading-relaxed">
                Rancang bangun jas single-breasted, double-breasted, maupun tuxedo ceremonial berkonstruksi full canvas atau half canvas. Kami menggunakan wol murni dari Super 130s hingga Super 180s pilihan (Ermenegildo Zegna, Loro Piana, VBC) yang menjamin ketajaman siluet bahu dan keanggunan lapel.
              </p>
            </div>
          ...
          <div className="p-10 border border-border/80 bg-card space-y-6 hover:border-foreground/60 transition-colors flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                <span className="font-serif text-2xl font-normal text-foreground">02. Kebaya &amp; Beskap Ceremonial</span>
                <Icon icon="mdi:flower-tulip-outline" className="text-3xl text-muted-foreground" />
              </div>
              <p className="font-serif text-base text-muted-foreground leading-relaxed">
                Perpaduan keagungan tradisi Nusantara dan ketepatan cutting modern. Pembuatan kebaya pengantin, beskap adat Jawa/Sunda, dan songket rancangan khusus dengan penataan brokat Prancis yang disesuaikan secara presisi dengan anatomi tubuh pemakainya.
              </p>
            </div>
            <div className="pt-4 flex items-center justify-between font-serif text-xs text-muted-foreground uppercase tracking-widest">
          ...
          <div className="p-10 border border-border/80 bg-card space-y-6 hover:border-foreground/60 transition-colors flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                <span className="font-serif text-2xl font-normal text-foreground">03. Busana Eksekutif &amp; Diplomatik</span>
                <Icon icon="mdi:briefcase-outline" className="text-3xl text-muted-foreground" />
              </div>
              <p className="font-serif text-base text-muted-foreground leading-relaxed">
                Koleksi pakaian kerja eksekutif (business suits, kemeja katun Mesir bermutu tinggi, dan celana formal bernapas) yang dirancang untuk kenyamanan maksimal dalam mobilitas tinggi, pertemuan kenegaraan, serta jamuan resmi.
              </p>
            </div>
            <div className="pt-4 flex items-center justify-between font-serif text-xs text-muted-foreground uppercase tracking-widest">
          ...
          <div className="p-10 border border-border/80 bg-card space-y-6 hover:border-foreground/60 transition-colors flex flex-col justify-between">
            <div className="space-y-4">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                <span className="font-serif text-2xl font-normal text-foreground">04. Alterasi &amp; Restorasi High-End</span>
                <Icon icon="mdi:content-cut" className="text-3xl text-muted-foreground" />
              </div>
              <p className="font-serif text-base text-muted-foreground leading-relaxed">
                Layanan penyesuaian ulang (recutting &amp; resizing) untuk jas impor dan busana mewah peninggalan keluarga. Master penjahit kami membongkar struktur jahitan lama dan menyusunnya kembali agar pas dan relevan dengan postur Anda hari ini.
              </p>
            </div>
            <div className="pt-4 flex items-center justify-between font-serif text-xs text-muted-foreground uppercase tracking-widest">
      ...
      {/* Section 2: Alur Kerja 4 Langkah (The Bespoke Journey) */}
      ...
      <section className="py-20 px-6 text-center max-w-4xl mx-auto space-y-6">
        <h2 className="font-serif text-3xl sm:text-4xl text-foreground font-normal">
          Mulai Konsultasi Karya Bespoke Anda
        </h2>
