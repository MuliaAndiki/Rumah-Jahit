    ...
    <div className="min-h-screen bg-muted/20 pb-16">
      ...
      <header className="sticky top-0 z-30 bg-background/80 backdrop-blur-md border-b border-border/80 px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="font-bold text-lg leading-tight text-foreground">Kelola Katalog Bespoke</h1>
            <p className="text-xs text-muted-foreground">Daftar item katalog dan galeri foto produk</p>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-8 space-y-6">
        ...
        <div className="flex items-center gap-2 border-b border-border/60 pb-4">
          ...
          <Link href="/catalog" className="px-4 py-2 rounded-xl bg-primary text-primary-foreground font-bold text-sm shadow-sm flex items-center gap-2">
            <Icon icon="mdi:hanger" className="text-lg" />
            Kelola Katalog
          </Link>
        </div>
